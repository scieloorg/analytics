...
def publication_article_references(request):
    ...
    chart_data = request.stats.publication.general('article', 'citations', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], 40, 'asc')
...
def publication_article_authors(request):
    ...
    chart_data = request.stats.publication.general('article', 'authors', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], 0, 'asc')
...
def publication_article_affiliations_map(request):
    ...
    chart_data = request.stats.publication.general('article', 'aff_countries', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_affiliations(request):
    ...
    chart_data = request.stats.publication.general('article', 'aff_countries', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], size=20)
...
def publication_article_affiliations_publication_year(request):
    ...
    chart_data = request.stats.publication.affiliations_by_publication_year(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_year(request):
    ...
    data_chart = request.stats.publication.general('article', 'publication_year', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], 0, 'desc')
...
def publication_article_languages(request):
    ...
    data_chart = request.stats.publication.general('article', 'languages', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_languages_publication_year(request):
    ...
    data_chart = request.stats.publication.languages_by_publication_year(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_journal_status(request):
    ...
    data_chart = request.stats.publication.general('journal', 'status', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_journal_year(request):
    ...
    data_chart = request.stats.publication.general('journal', 'included_at_year', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], 0, 'asc')
...
def publication_article_subject_areas(request):
    ...
    data_chart = request.stats.publication.general('article', 'subject_areas', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_subject_areas_publication_year(request):
    ...
    data_chart = request.stats.publication.subject_areas_by_publication_year(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_document_type(request):
    ...
    data_chart = request.stats.publication.general('article', 'document_type', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_licenses_publication_year(request):
    ...
    data_chart = request.stats.publication.lincenses_by_publication_year(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_article_licenses(request):
    ...
    data_chart = request.stats.publication.general('article', 'license', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_journal_subject_areas(request):
    ...
    data_chart = request.stats.publication.general('journal', 'subject_areas', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_journal_licenses(request):
    ...
    data_chart = request.stats.publication.general('journal', 'license', data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'])
...
def publication_size(request):
    ...
    data = request.stats.publication.collection_size(data['selected_code'], data['selected_collection_code'], field, data['py_range'], data['sa_scope'])
...
def bymonthandyear(request):
    ...
    data_chart = request.stats.access.access_by_month_and_year(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], range_start, range_end)
...
def documenttype(request):
    ...
    data_chart = request.stats.access.access_by_document_type(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], range_start, range_end)
...
def lifetime(request):
    ...
    data_chart = request.stats.access.access_lifetime(data['selected_code'], data['selected_collection_code'], data['py_range'], data['sa_scope'], range_start, range_end)
