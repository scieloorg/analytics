...
def main(global_config, **settings):
    ...
    config.add_route('bibliometrics_journal_publication_and_citing_years_heat_web', '/w/bibliometrics/journal/publication_and_citing_years_heat')
    ...
    config.add_route('bibliometrics_journal_publication_and_citing_years_heat', '/ajx/bibliometrics/journal/publication_and_citing_years_heat')
