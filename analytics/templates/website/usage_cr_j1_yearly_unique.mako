## coding: utf-8
<div id="usage_cr_j1_yearly_unique_chart" style="width:100%; height:400px;">
  <span id="loading_usage_cr_j1_yearly_unique_chart">
    <img src="/static/images/loading.gif" />
    <h5>${_(u'Carregando')}</h5>
  </span>
</div>
<script language="javascript">
    $("#loading_usage_cr_j1_yearly_unique_chart").show();
