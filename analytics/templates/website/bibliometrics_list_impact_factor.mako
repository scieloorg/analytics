...
<%block name="central_container">
  ...
  % else:
    ...
    <h3>${_(u'Fator de Impacto em 1, 2, 3 e 4 anos')}</h3>
      ...
      % for base_year, data in sorted(blist.items(), reverse=True):
        <% 
          ...
          citing_count1234 = int(data['citing_count1']+data['citing_count2']+data['citing_count3']+data['citing_count2'])
